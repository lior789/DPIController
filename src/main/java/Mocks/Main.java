...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            switch (mockType) {
                case "middlebox":
                    MockMiddleBox mmd = new MockMiddleBox(controllerIp, controllerPort, id, mockName);
                    mmd.run();
                    break;
                case "service":
                    MockDPIService mds = new MockDPIService(controllerIp, controllerPort, id, mockName);
                    mds.run();
                    break;
                default:
                    System.out.println("unsupported mock type should be service or middlebox");
            }
